...
const WorkCard = ({ work }: { work: Work }) => {
  return (
    <div className="group portfolio-item rounded-3xl overflow-hidden relative aspect-[4/3] bg-dark-lighter border border-white/5 shadow-premium transition-all duration-500 hover:-translate-y-2 hover:shadow-premium-hover">
      <Image
